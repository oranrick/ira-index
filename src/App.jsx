...
const ENTITIES = [
  ...
  },
  {
    ...
    score: 6.63,
    params: { pronominal:7.5, metafora:6.5, dicotomia:5.5, tono:7.0, disenso:5.5, vector:7.5, coherencia:6.5, proyeccion:7.5 },
    context: "Presidente del Gobierno de España (2018–). Analizado sobre discurso ante la 79.ª Asamblea General de la ONU, Nueva York, septiembre de 2024.",
    contextEn: "Prime Minister of Spain (2018–). Analyzed on speech before the 79th UN General Assembly, New York, September 2024.",
    paramTexts: {
      pronominal: "El discurso alterna entre España como sujeto institucional y un «nosotros» que aspira a abrazar a toda la humanidad: «nuestros hijos, nuestras hijas, nuestros nietos y nietas», «los 8.000 millones de habitantes de nuestro planeta». El «ellos» existe —«gente sin escrúpulos», «sus enemigos»— pero es estructural e ideológico, nunca personalizado en rivales domésticos concretos.",
      metafora:   "Las metáforas oscilan entre lo constructivo y lo defensivo-bélico. Por un lado: «levantó pieza a pieza de las cenizas», «luz al final del túnel», «mirando al horizonte». Por otro: «enfermedad global que corroe los cimientos», «levantar un escudo», «la democracia libra una batalla con una mano atada a la espalda». El marco bélico aparece como defensa de valores, no como ataque a personas.",
      dicotomia:  "La dicotomía es clara en el bloque sobre democracia: «agenda reaccionaria global» frente a progreso, «activistas de la mentira» frente a la razón, «delirantes discursos» que cuestionan la Agenda 2030. El adversario es deslegitimado intelectual y moralmente, aunque no se personaliza en individuos concretos. El agonismo democrático de Mouffe está ausente: el disenso reaccionario no se trata como posición legítima.",
      tono:       "El tono dominante es esperanza racional con destellos de indignación justa. Rechaza explícitamente el catastrofismo: «me niego a caer en la melancolía». La indignación ante Gaza, Ucrania o el retroceso democrático está siempre enmarcada en propuestas concretas. El cierre estadístico transforma la emoción en argumento: el progreso es demostrable, no solo deseable.",
      disenso:    "El discurso reconoce los límites propios y los errores colectivos de la democracia: «es necesario reconocer errores, trabajar por su regeneración interna». Sin embargo, no valida ni integra el disenso reaccionario —lo descalifica como «delirante». La apertura al disenso existe hacia los aliados multilaterales y hacia la autocrítica interna; la heteroglosia contractiva domina frente a los adversarios ideológicos.",
      vector:     "Los llamados a la acción son cooperativos, multilaterales y concretos: «Invito a todos los países a sumarse», «Apostemos por la refundación del multilateralismo», «Hagámoslo con creatividad, con audacia». Los imperativos apuntan a estructuras —multilateralismo, financiación, energía— nunca a adversarios humanos.",
      coherencia: "La coherencia es el eje argumental explícito del propio discurso: «el valor de la coherencia, la que nos ha llevado a decir lo mismo en Ucrania, en Gaza y en cualquier otro lugar». La política exterior feminista, el reconocimiento de Palestina, el apoyo a Ucrania y el tono dialogante se presentan como partes de un registro ético consistente.",
      proyeccion: "El futuro es colectivo, alcanzable y respaldado por datos: estadísticas de mortalidad infantil, energía solar, representación parlamentaria femenina. «El futuro es una conquista relativamente reciente para la humanidad» —una proyección que no promete paraísos sino que reivindica la capacidad histórica de mejorar. El cierre es modal y esperanzador: «Apostemos», «Hagámoslo».",
    },
    paramTextsEn: {
      pronominal: "The speech alternates between Spain as institutional subject and a 'we' that aspires to embrace all humanity: 'our children, our grandchildren', 'the 8 billion inhabitants of our planet'. The 'them' exists — 'unscrupulous people', 'its enemies' — but is structural and ideological, never personalized in specific domestic rivals.",
      metafora:   "Metaphors oscillate between the constructive and the defensive-martial. On one side: 'built piece by piece from the ashes', 'light at the end of the tunnel', 'looking toward the horizon'. On the other: 'global disease that corrodes the foundations', 'raise a shield', 'democracy fights a battle with one hand tied behind its back'. The martial frame appears as defense of values, not attack on persons.",
      dicotomia:  "The dichotomy is clear in the democracy block: the 'global reactionary agenda' against progress, 'activists of lies' against reason, 'delusional speeches' questioning Agenda 2030. The adversary is delegitimized intellectually and morally, though not personalized in specific individuals. Mouffe's democratic agonism is absent: reactionary dissent is not treated as a legitimate position.",
      tono:       "The dominant tone is rational hope with flashes of righteous indignation. He explicitly rejects catastrophism: 'I refuse to fall into melancholy'. Indignation at Gaza, Ukraine, or democratic backsliding is always framed within concrete proposals. The statistical closing transforms emotion into argument: progress is demonstrable, not merely desirable.",
      disenso:    "The speech acknowledges democracy's own limits and collective errors: 'it is necessary to recognize mistakes, to work toward internal regeneration'. However, it neither validates nor integrates reactionary dissent — it dismisses it as 'delusional'. Openness to dissent exists toward multilateral allies and internal self-criticism; contractile heteroglossia dominates in the face of ideological adversaries.",
      vector:     "Calls to action are cooperative, multilateral, and concrete: 'I invite all countries to join', 'Let us bet on the refoundation of multilateralism', 'Let us do it with creativity, with boldness'. Imperatives point to structures — multilateralism, financing, energy — never at human adversaries.",
      coherencia: "Coherence is the explicit argumentative axis of the speech itself: 'the value of coherence, which has led us to say the same thing in Ukraine, in Gaza, and everywhere else'. Feminist foreign policy, recognition of Palestine, support for Ukraine, and a dialogic tone are presented as parts of one consistent ethical register.",
      proyeccion: "The future is collective, attainable, and data-backed: statistics on child mortality, solar energy, female parliamentary representation. 'The future is a relatively recent conquest for humanity' — a projection that promises no paradise but vindicates humanity's historical capacity to improve. The closing is modal and hopeful: 'Let us bet', 'Let us do it'.",
    },
    quotes: {
      pronominal: "nuestros hijos, nuestras hijas, nuestros nietos y nietas",
      metafora:   "levantar un escudo que proteja las instituciones democráticas",
      dicotomia:  "la democracia libra una batalla por su supervivencia",
